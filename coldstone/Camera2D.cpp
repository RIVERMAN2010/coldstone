...
void Camera2D::RecalculateViewProjection() {
    // Camera Transform2D (inverse of world Transform2D)
    glm::mat4 Transform2D = glm::translate(glm::mat4(1.0f), glm::vec3(m_Position, 0.0f))
        * glm::rotate(glm::mat4(1.0f), m_Rotation, glm::vec3(0, 0, 1))
        * glm::scale(glm::mat4(1.0f), glm::vec3(m_Zoom, m_Zoom, 1.0f));

    m_View = glm::inverse(Transform2D);
